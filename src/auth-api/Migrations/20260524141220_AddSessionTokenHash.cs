        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "platform.metronome.manage", null, "Create / edit / disable platform-scope Metronome scheduled jobs. Required to access the tc-ops-ui Metronome panel and define cross-tenant operational jobs.", "Manage Scheduled Jobs (Metronome)", null, 0, 0 },
                    { "platform.tempo.manage", null, "Author / edit / disable platform-scope Tempo workflow definitions and view all instances across tenants. Required for the tc-ops-ui Tempo panel.", "Manage Workflows (Tempo)", null, 0, 0 },
