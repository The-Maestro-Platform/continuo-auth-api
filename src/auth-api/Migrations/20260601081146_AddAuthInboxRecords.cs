        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "platform.agreements.manage", null, "Edit and version the platform-level legal agreements (KVKK Aydınlatma, Kullanım Koşulları, Pazarlama İzni) shown to customers at signup/login. tc-ops-ui Agreements panel + auth-api admin CRUD endpoints.", "Manage Legal Agreements", null, 0, 0 },
